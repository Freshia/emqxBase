...
# Base settings in EMQ/emqx/emqx-rel/_build/emqx/rel/emqx/etc/emqx.conf
# Plugin settings in EMQ/emqx/emqx-rel/_build/emqx/rel/emqx/etc/plugins

_EMQX_HOME="EMQ/emqx/emqx-rel/_build/emqx/rel/emqx"
